...
# ================================================================
# ডেমো অ্যাড ডেটা (API কাজ না করলে ব্যবহার হবে)
# ================================================================
DEMO_ADS = [
    {
        "id": "demo_1",
        "image": "https://via.placeholder.com/400x250/1a1a2e/ffd700?text=Watch+Ad+1",
        "clickUrl": "https://example.com/ad1",
        "buttonText": "Go!",
        "text": "অ্যাড দেখুন এবং ১ টাকা আয় করুন!"
    },
    {
        "id": "demo_2",
        "image": "https://via.placeholder.com/400x250/1a1a2e/4caf50?text=Watch+Ad+2",
        "clickUrl": "https://example.com/ad2",
        "buttonText": "Click Here",
        "text": "নতুন অ্যাড দেখুন এবং আয় করুন!"
    },
    {
        "id": "demo_3",
        "image": "https://via.placeholder.com/400x250/1a1a2e/ff6b6b?text=Watch+Ad+3",
        "clickUrl": "https://example.com/ad3",
        "buttonText": "Visit",
        "text": "বিশেষ অফার দেখুন!"
    }
]

# ================================================================
# Adexium থেকে অ্যাড আনা (ডেমো ফallback সহ)
# ================================================================
def get_adexium_ad(telegram_id, first_name, is_premium=False):
    """Adexium API থেকে অ্যাড ডেটা আনো, ব্যর্থ হলে ডেমো দেবে"""
    try:
        ...
        if response.status_code == 200:
            ...
            # চেক করুন ডেটা ভালো কিনা
            if result and result.get('id'):
                return result
            else:
                print("⚠️ API থেকে খালি ডেটা এসেছে, ডেমো ব্যবহার করছি")
                return random.choice(DEMO_ADS)
        else:
            print(f"⚠️ API Error: {response.status_code}, ডেমো ব্যবহার করছি")
            return random.choice(DEMO_ADS)
            
    except Exception as e:
        print(f"⚠️ Exception: {e}, ডেমো ব্যবহার করছি")
        return random.choice(DEMO_ADS)
...
def task_command(message):
    ...
    # অ্যাড ডেটা আনুন (API + ডেমো ফallback)
