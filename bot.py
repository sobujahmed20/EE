...
# ================================================================
# ডেটা স্টোর (সিম্পল ডিকশনারি - প্রোডাকশনে ডাটাবেজ ব্যবহার করুন)
# ================================================================
users = {}
user_tasks = {}
...
def callback_handler(call):
    ...
    # ===== উইথড্র মেথড =====
        ...
        # উইথড্র রিকোয়েস্ট সেভ
        user_data = users.get(user_id, {})
        balance = user_data.get('balance', 0)
        
        if balance >= 50:
            # এখানে ডাটাবেজে সেভ করুন
            bot.edit_message_text(
    ...
    try:
        ...
        for uid in users.keys():
            try:
                ...
                count += 1
                time.sleep(0.05)  # রেট লিমিট এড়াতে
            except:
                pass
